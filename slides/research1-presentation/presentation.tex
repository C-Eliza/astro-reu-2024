...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=0.55\textwidth]{rrl.jpg}
  ...
  \begin{columns}
    ...
    \begin{column}{0.7\linewidth}
      ...
      \includegraphics[height=1in]{figures/wind.png}
			{\teeny\\ \hyperlink{https://www.vecteezy.com/png/19787026-fire-icon-on-transparent-background}{Fire Image Source Here}}
